...
export default function Home() {
  ...
  return (
    <div className="flex justify-center bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 min-h-screen py-8 px-4">
      {/* Main container with refined shadow and border */}
      <div className="w-[70%] flex flex-col rounded-xl shadow-lg border border-slate-700 overflow-hidden h-[90vh]">
        <Header />
